...
; (function($) {
    ...
    $.fn.bcalendar = function(option) {
        ...
        //
        gridcontainer.css("overflow-y", "visible").height(option.height - 8 - 20);
        ...
        function render() {
            ...
            if (option.view == "day" || option.view == "week") {
                var $dvtec = $("#dvtec");
                if ($dvtec.length > 0) {
                    option.scoll =  $dvtec.scrollTop() ;//$dvtec.attr("scrollTop"); //get scroll bar position
                }
            }
        ...
        function BuildMonthView(showday, events, config) {
            ...
            html.push("</div>");
            var bH = GetMonthViewBodyHeight() - GetMonthViewHeaderHeight() - 20;
        ...
        function BuildDayEvent(theme, e, index) {
            ...
            var icons = [];
			if(e.event[8] == 0)
				icons.push("<I class=\"cic cic-priv\">&nbsp;</I>");
            if (e.reevent)
        ...
        function BuildMonthDayEvent(e, cday, length) {
            ...
            var i = (e.event[8] == 0) ? "<I class=\"cic cic-priv\">&nbsp;</I>" : "";
        ...
        function gW(ts1, ts2) {
			...
			var t3 = 0;
			var diff3 = t1 - t2; 
			if(diff3 >= 0 && diff3 < 0.25 )
				t3 = 0 ;
			else
				if(diff3 >= 0.25 && diff3 < 0.5 )
					t3 = 15 ;
			else
				if(diff3 >= 0.5 && diff3 < 0.75)
					t3 = 30 ;
			else
				if(diff3 >= 0.75 )
					t3 = 45 ;
			...
			var t6 = 0;
			var diff6 = t4 - t5; 
				if(diff6 >= 0 && diff6 < 0.25 )
					t6 = 0 ;
				else
				if(diff6 >= 0.25 && diff6 < 0.5 )
					t6 = 15 ;
				else
				if(diff6 >= 0.5 && diff6 < 0.75)
					t6 = 30 ;
				else
				if(diff6 >= 0.75 )
					t6 = 45 ;
        ...
        function buildtempdayevent(sh, sm, eh, em, h, title, w, resize, thindex) {
            ...
            var newtemp = Tp(__SCOLLEVENTTEMP, {
                ...
                title: "",
                //icon: (e.event[8] == 0) ? "<I class=\"cic cic-priv\">&nbsp;</I>" : "",
				icon:"",
                top: "0px",
                left: "",
                width: w ? w : "100%",
        ...
        function parseED(data) {
            if (data.length > 6) {
                var e = [];
                e.push(data[0], data[1], new Date(data[2]), new Date(data[3]), parseInt(data[4]), parseInt(data[5]), parseInt(data[6]), data[7] != undefined ? parseInt(data[7]) : -1, data[8] != undefined ? parseInt(data[8]) : 0, data[9], data[10], data[11], data[12], data[13]);
                return e;
            }
            return null;
            ...
            if (data != null) {
                if (option.quickDeleteUrl != "" && data[8] == 1 && option.readonly != true) {
                    var csbuddle = '<div id="bbit-cs-buddle" style="z-index: 180; width: 400px;visibility:hidden;" class="bubble"><table class="bubble-table" cellSpacing="0" cellPadding="0"><tbody><tr><td class="bubble-cell-side"><div id="tl1" class="bubble-corner"><div class="bubble-sprite bubble-tl"></div></div><td class="bubble-cell-main"><div class="bubble-top"></div><td class="bubble-cell-side"><div id="tr1" class="bubble-corner"><div class="bubble-sprite bubble-tr"></div></div>  <tr><td class="bubble-mid" colSpan="3"><div style="overflow: hidden" id="bubbleContent1"><div><div></div><div class="cb-root"><table class="cb-table" cellSpacing="0" cellPadding="0"><tbody><tr><td class="cb-value"><div class="textbox-fill-wrapper"><div class="textbox-fill-mid"><div id="bbit-cs-what" title="'
                    	+ i18n.xgcalendar.click_to_detail + '" class="textbox-fill-div" style="font-weight:bold"></div></div></div></td></tr><tr><td class=cb-value><div id="bbit-cs-buddle-timeshow"></div></td></tr></tbody></table><div class="bbit-cs-split"><a id="linkHistory" href="index.php?r=task/view&id='+data[0]+'" class="lk">Historique</a>&nbsp;<input id="bbit-cs-id" type="hidden" value=""/>|&nbsp;<span id="bbit-cs-delete" class="lk">'
                    ...
                    if (bud.length == 0) {
						...
						var linkHistory = $("#linkHistory");
						linkHistory.click(function(e) {
					...
					ss.push("<br>Statut: ",data[13]);
					ss.push("<br>Pourcentage complet: ",data[6],"%");
					ss.push("<br>Client: ",data[9]);
					ss.push("<br>Service: ",data[10]);
					ss.push("<br>Activité: ",data[11]);
					//ss.push("<br><a id='linkHistory' href='index.php?r=task/view&id="+data[0]+"'>Historique</a>");
					
					if(data[12] != "")
						ss.push("<br>Assigned To: ",data[12]);
        ...
        function dayupdate(data, start, end) {
            if (option.quickUpdateUrl != "" && data[8] == 1 && option.readonly != true) {
                ...
                var param = [{ "name": "id", value: id },
							{ "name": "StartDate", value: dateFormat.call(start, i18n.xgcalendar.dateformat.fulldayvalue + " HH:mm") },
							{ "name": "EndDate", value: dateFormat.call(end, i18n.xgcalendar.dateformat.fulldayvalue + " HH:mm") },
							{ "name": "timezone", value: zone }
						   ];
                var d;
        ...
        function ResizeView() { //alert("resise-view");
            ...
            if (_viewType == "day" || _viewType == "week") {
                ...
                var calH = option.height - 8 - dvwkH - 20;
                ...
                switch (d.type) {
                    case 1:
                        ...
                        if (diffy > 11 || diffy < -11 || d.cpwrap) {
                            if (diffy == 0) { diffy = (21/2); }
                            var dy = diffy % (21/2);
                            if (dy != 0) {
                                diffy = dy > 0 ? diffy + (21/2) - dy : diffy - (21/2) - dy;
                                y = d.sy + diffy;
                                if (diffy < 0) {
                                    sy = sy + (21/2);
                                }
